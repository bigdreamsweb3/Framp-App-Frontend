  ...
  "inline-flex items-center justify-center gap-[max(0.25rem,0.5vw)] md:gap-2 whitespace-nowrap font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[max(0.9rem,1.8vw)] [&_svg:not([class*='size-'])]:md:size-4 shrink-0 [&_svg]:shrink-0 outline-none rounded-xl backdrop-blur-sm relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-accent/30 hover:text-accent-foreground dark:hover:bg-accent/40 transition-all duration-200",
        soft_gradient:
          "bg-gradient-to-r from-primary/15 to-primary/10 border border-border text-foreground/90 dark:text-foreground font-semibold hover:from-primary/25 hover:to-primary/15 hover:border-primary/50 shadow-[0_0_10px_rgba(var(--primary-rgb),0.15)] hover:shadow-[0_0_14px_rgba(var(--primary-rgb),0.25)]",
        link:
